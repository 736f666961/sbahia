...
<html>
	...
	<body>
		...
		%>     
        <div class="container">
            <form action="/sbahia/editProduct/?id=<%= productID %>" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="productDescription" placeholder="Enter description of product" name="product_description" value="<%= product.getproductDescription() %>">
              </div>
